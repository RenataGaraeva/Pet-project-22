...
export default function Favourite ({name, galleryForPage}) {
    ...
    return (
        ...
        <div className='containterForButtonsOfСarouselAndTitle'>
            ...
            <h3 id="titleFavorites" className="titleFavorites">Мои любимые {name}</h3>
                    ...
                    (
                        <button className="leftButtonForCarousel" type="button" onClick={left}>
                            <svg width="48" height="48" className="ArrowSvgForCarousel"
                                ...
                                <line x1="12" y1="24" x2="36" y2="24" stroke="black" stroke-width="3"
                                      stroke-linecap="round"/>
                                <line x1="12" y1="24" x2="20" y2="31" stroke="black" stroke-width="3"
                                      stroke-linecap="round"/>
                                <line x1="12" y1="24" x2="20" y2="18" stroke="black" stroke-width="3"
                                      stroke-linecap="round"/>
                    ...
                    (
                        ...
                        <button className="rightButtonForCarousel" type="button" onClick={right}>
                            <svg width="48" height="48" className="ArrowSvgForCarousel"
                                ...
                                <line x1="12" y1="24" x2="36" y2="24" stroke="black" stroke-width="3"
                                      stroke-linecap="round"/>
                                <line x1="36" y1="24" x2="28" y2="17" stroke="black" stroke-width="3"
                                      stroke-linecap="round"/>
                                <line x1="36" y1="24" x2="28" y2="30" stroke="black" stroke-width="3"
                                      stroke-linecap="round"/>
    ...
    <figure>
        <img className="photoFromCarousel" src={galleryForPage[galleryPhotoItem].src}/>
